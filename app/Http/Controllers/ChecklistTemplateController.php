...
class ChecklistTemplateController extends Controller
{
    ...
    {
        $templates = ChecklistTemplate::with(['kategori', 'sarpras', 'items'])
    ...
    public function create()
    {
        ...
        $sarprasList = Sarpras::orderBy('nama')->get();
        return view('checklist.create', compact('kategoris', 'sarprasList'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // Jika ada sarpras_id, ambil kategori_id dari sarpras tersebut
        $kategoriId = $request->kategori_id;
        if ($request->sarpras_id) {
            $sarpras = Sarpras::find($request->sarpras_id);
            $kategoriId = $sarpras->kategori_id;
        }
    ...
    public function edit(ChecklistTemplate $checklist)
    {
        ...
        return view('checklist.edit', compact('checklist', 'kategoris', 'sarprasList'));
    }
