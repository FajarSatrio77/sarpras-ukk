...
@section('title', 'Sampah Pengaduan')

@section('content')
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
    <div>
        <h2 style="font-size: 1.5rem; font-weight: 700; color: var(--dark);">
            <i class="bi bi-trash3"></i> Sampah Pengaduan
        </h2>
        <p style="color: var(--secondary);">Data pengaduan yang sudah dihapus</p>
    </div>
    <a href="{{ route('pengaduan.index') }}" class="btn btn-outline">
